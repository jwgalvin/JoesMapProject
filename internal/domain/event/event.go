...
func NewEvent(id string, location Location, place string, magnitude Magnitude, eventType Type, eventTime, updatedTime time.Time, status, description, url string) (*Event, error) {
	if id == "" {
